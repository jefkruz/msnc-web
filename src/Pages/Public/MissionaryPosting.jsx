...
const fieldClass =
    'w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 text-slate-900 placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20';
        ...
        <PublicLayout branding={branding} active="opportunity-to-work-in-ministry">
            <section className="page-hero">
                <div className="public-container">
                    {home.posting_eyebrow && <span className="section-label">{home.posting_eyebrow}</span>}
                    <h1>{home.posting_title || 'Opportunity to work in ministry'}</h1>
                </div>
            </section>
            ...
            <section className="public-section public-section--soft" id="register">
                <div className="public-container">
                    <div className="register-card">
                        ...
                        <form onSubmit={submit} className="register-form" noValidate>
                            ...
                            <div className="register-actions">
                                <button type="submit" className="btn-mca btn-mca-blue" disabled={processing}>
